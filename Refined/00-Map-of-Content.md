...
A análise indica que a **estrutura de incentivos financeiros** gera passivos ocultos ao **priorizar economias de curto prazo em detrimento da sustentabilidade** dos contratos, resultando em alta vulnerabilidade jurídica e operacional.
...
<h3>💰 Arquitetura de Incentivos</h3>
<ul>
<li><a href="#01"><strong>O custo invisível da margem</strong><span class="nav-desc">Como economia em manutenção vira passivo trabalhista.</span></a></li>
</ul>
</div>

<div class="nav-card risk">
<h3>🧠 Riscos Psicossociais</h3>
<ul>
<li><a href="#02"><strong>Quais os riscos associados às condições de trabalho atuais?</strong><span class="nav-desc">Mapeamento de riscos de processos coletivos e afastamentos.</span></a></li>
</ul>
</div>
...
<ul>
<li><a href="#03"><strong>O impasse estrutural do travamento rescisório</strong><span class="nav-desc">A análise do "travamento rescisório" e a armadilha do FGTS.</span></a></li>
</ul>
</div>
