...
## 1. O Mecanismo Central: Por Que Demissões Não Acontecem
...
## 2. A Perspectiva do Colaborador: O Aprisionamento Financeiro

O modelo brasileiro de proteção ao desemprego (multa de 40% do FGTS + acesso ao saldo + seguro-desemprego) cria um incentivo financeiro para que o trabalhador de baixa renda busque a demissão sem justa causa. Para quem ganha pouco, a rescisão representa uma capitalização que não seria possível apenas poupando o salário.

Colaboradores com anos de casa (5, 10, até 20 anos) desejam sair devido às condições de trabalho e aos baixos salários. No entanto, pedir demissão significaria abrir mão de direitos acumulados ao longo de décadas. Eles se recusam a sair "com uma mão na frente e outra atrás".
...
## 3. O Ciclo Vicioso: Quando os Interesses se Chocam

A combinação das restrições orçamentárias (que impedem demissões) com a necessidade do colaborador de acessar suas verbas (que impede pedidos de demissão) cria um impasse com consequências graves:
...
## 4. As Consequências Operacionais

| Dimensão | Impacto Observado |
|----------|-------------------|
| **Qualidade do serviço** | Tarefas mal executadas ou incompletas |
| **Produtividade** | Queda no ritmo de trabalho |
| **Clima organizacional** | Tensão entre quem trabalha e quem "faz hora" |
| **Saúde da liderança** | Desgaste emocional ao lidar com equipes desmotivadas |
| **Imagem institucional** | Percepção de impunidade e falta de meritocracia |

**Estimativa de custo:**
Se um funcionário "travado" produz 50% do esperado e ganha R$ 2.000/mês, a operação está perdendo R$ 1.000/mês de produtividade. Em uma unidade com 5 funcionários nessa condição, são R$ 60.000/ano de custo invisível. Este custo não aparece em nenhum relatório, mas corrói a operação diariamente.

---

## 5. Síntese

O "travamento rescisório" não é uma falha pontual de gestão, mas uma **consequência direta de como os custos de desligamento são contabilizados**. A alocação desses custos no centro de custo da unidade cria um conflito de interesses estrutural:

- A liderança local é incentivada a evitar desligamentos para proteger seu resultado financeiro.
