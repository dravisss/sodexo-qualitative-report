...
A análise qualitativa de três unidades operacionais (Cajamar e Guarulhos) revelou que a **estrutura de incentivos financeiros da operação está gerando passivos que não aparecem no resultado mensal**. A margem de lucro reportada mascara sua própria insustentabilidade.

---

## Os Cinco Mecanismos de Risco
...
| Intervenção | Hipótese | Métrica de Sucesso |
|-------------|----------|-------------------|
| **Fundo Centralizado de Renovação** | Separar rescisões do orçamento da unidade permitirá renovação saudável | Redução do tempo de permanência de desengajados; melhora em indicadores de clima |
| **Bônus de Assiduidade Escalonado** | Perda proporcional (não total) reduzirá presenteísmo | Redução de afastamentos INSS prolongados |
| **Orçamento Protegido para Manutenção** | Manutenções críticas não podem ser adiadas para proteger margem | Redução de acidentes; melhora em auditorias |
| **Reposicionamento da Proposta de Valor** | Benefícios diferenciados e ambiente melhorado reduzirão rotatividade | Aumento do tempo médio de permanência; redução de vagas abertas |
...
👉 **[Acesse aqui o Plano de Intervenção "Estancamento de Sangria" (Doc 08)](file:///Users/Ravi/Apps/Qualitative%20Analyst/docs/Analise%20Geral/Refined/08-plano-de-intervencao-estrategica.md)**
