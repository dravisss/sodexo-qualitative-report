...
Este documento organiza as intervenções em **Frentes de Atuação**.

>Embora haja uma lógica de precedência (estancar antes de operar), estas frentes não são estanques no tempo. Elas se sobrepõem e devem ser atacadas simultaneamente conforme a capacidade de execução permitir.
...
## FRENTE 4: REPOSICIONAMENTO (Longo Prazo & Futuro)
