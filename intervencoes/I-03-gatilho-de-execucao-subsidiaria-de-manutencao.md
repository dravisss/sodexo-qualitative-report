...
iniciativas_relacionadas:
  - "I-06"
---
# I-03 — Manutenção de Equipamentos de Infraestrutura do cliente
...
- **Descrição:** Aproveitar o período de renovação de contratos que acontecem a cada 3 anos e instituir protocolo de aplicação de multa no cliente. GU faz registro de chamado pro cliente e estabelece um SLA entre as partes. A GU não pode ser a pessoa que negocia com o cliente — é necessário um diretor como agente de pressão, visto que a GU não tem poder político na maioria das vezes.
