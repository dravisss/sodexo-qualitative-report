...
- Cliente pode tratar como “pressão” ou escalar conflito contratual.
- Sem sponsor do cliente, vira ritual que não muda execução.
- Risco de confundir obrigação do cliente com obrigações operacionais da Sodexo.

## Respostas (com base em evidências)

- O contrato já opera com formalização de negociações e faturamento retroativo, então a notificação é coerente com o mecanismo de governança existente.
- O roteiro mostra dependência externa para anual e GM target, o que indica que decisões e informações-chave circulam fora do documento e precisam ser registradas em rito e canal formais para virar trilha.
- A intervenção pode ser desenhada com perímetro mínimo e critério objetivo de conclusão, reduzindo disputa sobre o que foi entregue.

## Viabilidade prática

- Execução (recursos/rotina):
  - Consolidar uma lista curta de itens críticos.
  - Redigir minuta padrão de 1 página.
  - Enviar por canal contratual e registrar resposta.
  - Acompanhar até conclusão, com evidências e escalonamento.
- Governança (quem decide/mede):
  - Dono Sodexo do rito.
  - Sponsor do cliente definido.
  - Regra de escalonamento e cadência de acompanhamento.
- Custo (capex/opex):
  - Baixo custo direto.
  - Principal custo é tempo de rotina e follow-up.
- Dependências (cliente/contrato):
  - Canal contratual acordado.
