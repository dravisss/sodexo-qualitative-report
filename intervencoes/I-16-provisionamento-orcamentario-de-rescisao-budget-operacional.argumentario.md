...
---
# Argumentário — I-16 — Provisionamento Orçamentário de Rescisão (Budget Operacional)
...
- `intervencoes/I-16-provisionamento-orcamentario-de-rescisao-budget-operacional.md` (apêndice de rastreabilidade)
