...
### Evidência 1 — Ritual desperdiçado e sobrecarga do GU
> Fonte: War Room / Transcrição Audio 6
> Contexto: Relatos de que o DDS vira apenas assinatura de lista por falta de tempo do GU para preparar pautas relevantes.
...
- Criar banco de pautas "enlatadas" (Comunicação Interna).
- Treinar GUs para "ler e debater" em vez de apenas "assinar".
