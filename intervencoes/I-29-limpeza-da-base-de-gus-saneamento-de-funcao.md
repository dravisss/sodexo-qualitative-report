...
### Evidência 1 — Inflação de cargos de GU
> Fonte: War Room / Transcrição Audio 4
> Contexto: Identificação de "falsos GUs" na base que não gerem unidade, apenas para justificar salário.
...
- Mapeamento da base atual (Quantos GUs vs Quantas Unidades Físicas).
- Plano de migração/enquadramento (Risco trabalhista de rebaixamento?).
