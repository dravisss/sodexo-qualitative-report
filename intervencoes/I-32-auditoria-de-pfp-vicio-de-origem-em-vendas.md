...
### Evidência 1 — Vício de origem no dimensionamento
> Fonte: War Room / Transcrição Audio 2
> Contexto: Discussão sobre contratos que já nascem com necessidade de hora extra estrutural por erro de venda.
...
- Definir quem tem poder de veto (Diretoria Operacional?).
- Criar checklist de "Saúde Operacional Mínima" para o Bid.
